...
# ==================================================
# Link Hosting Kalian
akbarvpn="raw.githubusercontent.com/INAVPN/SSHAutoScript/master/wireguard"
...
# Tambahan
cd /usr/bin
wget -O addwg "https://raw.githubusercontent.com/INAVPN/SSHAutoScript/master/wireguard/addwg.sh"
wget -O delwg "https://raw.githubusercontent.com/INAVPN/SSHAutoScript/master/wireguard/delwg.sh"
wget -O renewwg "https://raw.githubusercontent.com/INAVPN/SSHAutoScript/master/wireguard/renewwg.sh"
chmod +x addwg
chmod +x delwg
chmod +x renewwg
cd
